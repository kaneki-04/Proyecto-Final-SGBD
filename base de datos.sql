...
CREATE TABLE Ventas (
    ...
    CONSTRAINT fk_cliente FOREIGN KEY (id_cliente) REFERENCES Clientes(id_cliente) ON DELETE SET NULL -- Si se elimina un cliente, la venta queda registrada pero sin cliente
);
...
CREATE TABLE Detalle_Ventas (
    ...
    CONSTRAINT fk_venta FOREIGN KEY (id_venta) REFERENCES Ventas(id_venta) ON DELETE CASCADE, -- Si se elimina una venta, se eliminan sus detalles
    CONSTRAINT fk_producto FOREIGN KEY (id_producto) REFERENCES Productos(id_producto) ON DELETE RESTRICT -- No se puede eliminar un producto si está en ventas
);
...
CREATE TABLE Detalle_Compras (
    ...
    CONSTRAINT fk_producto_compra FOREIGN KEY (id_producto) REFERENCES Productos(id_producto) ON DELETE RESTRICT
);
